'''
Exercise 11-3: Zooming in and out

Use the keyPressed() fnction you learned about in chapter 10 to change
the value  of the width variable w using the up and down keys. This should
let you zoom in and out of the CA!'''
